...
final class OverlayWindowController {
    ...
    private func configurePanels() {
        ...
        configurePanel(resetSizeButtonPanel, acceptsInput: false, level: controlLevel)
    ...
    private func animateGenieShow() {
        ...
        // Hide interactive companion panels during animation.
        let controlPanels = [scrollbarPanel]
    ...
    private func orderPanelsBelowFrontmostApplication() {
        ...
        let orderedPanels: [NSWindow] = [panel, scrollbarPanel]
